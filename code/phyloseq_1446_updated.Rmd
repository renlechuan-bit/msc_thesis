...
tax_bac <- process_taxonomy("/data/gpfs/projects/punim2504/msc_thesis/data/gtdb/bac120_taxonomy_r220.tsv")
tax_arc <- process_taxonomy("/data/gpfs/projects/punim2504/msc_thesis/data/gtdb/ar53_taxonomy_r220.tsv")
...
tree_bac <- read.tree("/data/gpfs/projects/punim2504/msc_thesis/data/gtdb/bac120_r220.tree")
tree_arc <- read.tree("/data/gpfs/projects/punim2504/msc_thesis/data/gtdb/ar53_r220.tree")
tree_all <- bind.tree(tree_bac, tree_arc)


meta_bac <- fread("/data/gpfs/projects/punim2504/msc_thesis/data/gtdb/bac120_metadata_r220.tsv")
meta_arc <- fread("/data/gpfs/projects/punim2504/msc_thesis/data/gtdb/ar53_metadata_r220.tsv")
...
## metadata
```{r}
metadata <- read_csv("/data/gpfs/projects/punim2504/msc_thesis/data/metadata_1446.csv") %>%
